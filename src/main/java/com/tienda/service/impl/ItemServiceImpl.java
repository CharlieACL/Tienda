...
public class ItemServiceImpl implements ItemService {
    ...
    //Se usa en el addCarrito... agrega un elemento al carrito
    @Override
    ...
    public void facturar() {
        ...
        if (principal instanceof UserDetails userDetails) {
            username = userDetails.getUsername();//revisa el nombre de usuario del cual uno este logeado
        } else {
            username = principal.toString();//nombre de usuario blanco
        }
