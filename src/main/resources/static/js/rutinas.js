...
function readURL(input) {
    if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
            $('#blah') //Cambia el blah(esta en templates fragmentos) que es donde se ve el icono de importar imagen al agregar categoria por la imagen que escogimos para visualizarla
